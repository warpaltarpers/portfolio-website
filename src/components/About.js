...
function About() {
  return (
    <>
      ...
      <p className='font-sans text-base lg:text-lg text-aqua-haze w-3/4 lg:w-2/3 mt-3'>Since graduating, I've had the opportunity to work on <span className='text-vibrant-purple'>international research for pediatric acute flaccid myelitis therapy through games</span>, <span className='text-vibrant-purple'>esports-inspired marketing strategies</span>, and a <span className='text-vibrant-purple'>J.D. Power Award winning mobile banking app</span>.</p>
